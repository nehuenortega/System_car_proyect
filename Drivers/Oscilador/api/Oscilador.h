...
#include "My_Types.h"
	...
	#define		DIR_SCS			( (volatile uint32_t *) 0x400FC1A0UL)
	//0x400FC104UL: Registro de configuracion del clock:
	#define		DIR_CCLKCFG		( (volatile uint32_t *) 0x400FC104UL)
	//0x400FC10CUL: Registro de seleccion del clock:
	#define		DIR_CLKSRCSEL	( (volatile uint32_t *) 0x400FC10CUL)
	//0x400FC1C8UL: Clock Output Config register:
	#define		DIR_CLKOUTCFG	( (volatile uint32_t *) 0x400FC1C8UL)
	//0x400FC000UL: Flash access configuration:
	#define		DIR_FLASHCFG	( (volatile uint32_t *) 0x400FC000UL)

	/////////////////Registros de los PLL///////////////////////////
	//0x400FC080UL: Registro de control del PLL0:
	#define		DIR_PLL0CON		( (volatile uint32_t *) 0x400FC080UL)
	//0x400FC084UL: Registro de configuracion del PLL0:
	#define		DIR_PLL0CFG		( (volatile uint32_t *) 0x400FC084UL)
	//0x400FC088UL: Registro de estado del PLL0:
	#define		DIR_PLL0STAT	( (volatile uint32_t *) 0x400FC088UL)
	//0x400FC08CUL: Registro de control del PLL0:
	#define		DIR_PLL0FEED	( (volatile uint32_t *) 0x400FC08CUL)
	//0x400FC0A0UL: Registro de control del PLL1:
	#define		DIR_PLL1CON		( (volatile uint32_t *) 0x400FC0A0UL)
	//0x400FC0A4UL: Registro de configuracion del PLL1:
	#define		DIR_PLL1CFG		( (volatile uint32_t *) 0x400FC0A4UL)
	//0x400FC0A8UL: Registro de estado del PLL1:
	#define		DIR_PLL1STAT	( (volatile uint32_t *) 0x400FC0A8UL)
	//0x400FC0ACUL: Registro de control del PLL1:
	#define		DIR_PLL1FEED	( (volatile uint32_t *) 0x400FC0ACUL)
